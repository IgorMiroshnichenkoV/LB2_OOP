...
public class JFrameApp extends JFrame {
    ...
    public JFrameApp() {
        ...
        label5.setBounds(10, 210, 260, 20);
        frame.add(label5);
        label5.setVisible(false);

        JLabel label6 = new JLabel();
        label6.setBounds(10, 240, 260, 20);
        frame.add(label6);
        label6.setVisible(false);

        JLabel label7 = new JLabel();
        label7.setBounds(10, 270, 260, 20);
        frame.add(label7);
        label7.setVisible(false);

        JLabel label8 = new JLabel();
        label8.setBounds(10, 300, 260, 20);
        frame.add(label8);
        ...
        btnClearColor.addActionListener(actionEvent -> {
            txt7.setText("");
        });

        btnEnter.addActionListener(actionEvent -> {
            label5.setVisible(true);
            door.material = txt1.getText();
            label5.setText("Матеріал: " + door.material);
            System.out.println("material Enter: " + door.material);

            label6.setVisible(true);
            door.height = Integer.parseInt(txt2.getText());
            label6.setText("Висота: " + door.height);
            System.out.println("height Enter: " + door.height);

            label7.setVisible(true);
            door.width = Integer.parseInt(txt3.getText());
            label7.setText("Ширина: " + door.width);
            System.out.println("width Enter: " + door.width);

            label8.setVisible(true);
            door.color = txt4.getText();
            label8.setText("Колір: " + door.color);
            System.out.println("color Enter: " + door.color);
        ...
        btnEnterColor.addActionListener(actionEvent -> {
            door.paint(door.color);
            label16.setVisible(true);
            door.color = txt7.getText();
            label16.setText("Колір змінено на: " + door.color);
            System.out.println("color Size: " + door.color);
        });
        ...
        btnDeleteColor.addActionListener(actionEvent -> {
            label16.setText("");
        });
